...
T.Popup {
    ...
    property Component closeButtonDelegate: AntCaptionButton {
        topPadding: 2
        bottomPadding: 2
        leftPadding: 4
        rightPadding: 4
    ...
    property Component stepCardDelegate: AntRectangleInternal {
    ...
    Item {
        ...
        Behavior on focusX {
            ...
            NumberAnimation { easing.type: Easing.OutQuart; duration: AntTheme.Primary.durationSlow }
        }
        Behavior on focusY {
            enabled: control.animationEnabled
            NumberAnimation { easing.type: Easing.OutQuart; duration: AntTheme.Primary.durationSlow }
