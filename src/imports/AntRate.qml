...
Item {
    ...
    property var fillIcon: AntIcon.StarFilled || ''
    property var emptyIcon: AntIcon.StarFilled || ''
    property var halfIcon: AntIcon.StarFilled || ''
    property Component fillDelegate: AntIconText {
    ...
    property Component emptyDelegate: AntIconText {
    ...
    property Component halfDelegate: AntIconText {
        colorIcon: control.colorEmpty
        iconSource: control.emptyIcon
        iconSize: control.iconSize
    ...
    QtObject {
        ...
        property bool supportsHalfAnimation: control.allowHalf &&
            ((fillIcon === AntIcon.StarFilled && emptyIcon === AntIcon.StarFilled) || halfIcon !== emptyIcon)
    }
}
