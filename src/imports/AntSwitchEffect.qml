...
Item {
    ...
    objectName: '__AntSwitchEffect__'
    ...
    Loader {
        active: control.type === AntSwitchEffect.TypeOpacity
        anchors.fill: parent
    ...
    Loader {
        active: control.type === AntSwitchEffect.TypeBlurry
        anchors.fill: parent
        sourceComponent: Item {
            MultiEffect {
                source: control.fromItem
    ...
    Loader{
        active: control.type === AntSwitchEffect.TypeMask
        anchors.fill: parent
        sourceComponent: Item {
            Item {
                id: mask
    ...
    Loader {
        active: control.type === AntSwitchEffect.TypeBlinds
        anchors.fill: parent
        sourceComponent: Item {
            Item {
                id: blindsMask
                ...
                Image {
                    ...
                    source: control.maskSource || 'qrc:/Antilla/resources/images/hblinds.png'
                    scale: control.maskScaleEnabled ? control.maskScale : 1
                    rotation: control.maskRotationEnabled ? control.maskRotation : 0
                    smooth: false
                }
    ...
    Loader {
        active: control.type === AntSwitchEffect.Type3dFlip
        anchors.fill: parent
        sourceComponent: Item {
            MultiEffect {
                ...
                maskEnabled: true
                maskSource: Image {
                    source: control.maskSource || 'qrc:/Antilla/resources/images/smoke.png'
                    visible: false
                }
    ...
    Loader {
        active: control.type === AntSwitchEffect.TypeThunder
        anchors.fill: parent
        sourceComponent: Item {
            ...
            Image {
                id: thunderMask
                source: control.maskSource || 'qrc:/Antilla/resources/images/stripes.png'
                scale: control.maskScaleEnabled ? control.maskScale : 1
                rotation: control.maskRotationEnabled ? control.maskRotation : 0
                visible: false
            }
