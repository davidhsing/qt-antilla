...
T.Control {
    ...
    property int lineStyle: AntTree.LineSolid
    property real lineWidth: 1
    property list<real> dashPattern: [4, 4]
    property var switcherIconSouce: AntIcon.CaretRightOutlined ?? ''
    ...
    property var themeSource: AntTheme.AntTree
    ...
    property Component switcherDelegate: AntRectangleInternal {
    ...
    property Component nodeContentDelegate: Item {
        ...
        AntRectangleInternal {
            ...
            color: {
                if (isSelected) {
                    return AntTheme.isDark ? control.themeSource.colorSelectionDark :
    ...
    component LinkLine: Shape {
        ...
        ShapePath {
            strokeStyle: control.lineStyle === AntTree.LineSolid ? ShapePath.SolidLine : ShapePath.DashLine
