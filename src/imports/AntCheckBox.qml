...
T.CheckBox {
    ...
    Behavior on colorIndicator { enabled: control.animationEnabled; ColorAnimation { duration: AntTheme.Primary.durationMid } }
    Behavior on colorIndicatorBorder { enabled: control.animationEnabled; ColorAnimation { duration: AntTheme.Primary.durationFast } }
    ...
    indicator: Item {
        ...
        AntRectangleInternal {
            ...
            Item {
                ...
                Behavior on scale {
                    enabled: control.animationEnabled
                    NumberAnimation { easing.overshoot: 2.5; easing.type: Easing.OutBack; duration: AntTheme.Primary.durationSlow }
                }
    ...
    contentItem: AntText {
        ...
        Behavior on opacity {
            enabled: control.animationEnabled
            NumberAnimation { duration: AntTheme.Primary.durationMid }
        }
    }
    background: Item { }
