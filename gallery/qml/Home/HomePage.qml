...
Rectangle {
    ...
    Flickable {
        ...
        component Card: MouseArea {
            ...
            Behavior on scale { NumberAnimation { duration: AntTheme.Primary.durationFast } }
            ...
            DropShadow {
                ...
                Behavior on color { ColorAnimation { duration: AntTheme.Primary.durationMid } }
            ...
            Rectangle {
                id: __rect
                anchors.fill: parent
                color: AntThemeFunctions.alpha(AntTheme.Primary.colorBgBase, 0.8)
                radius: 6
            ...
            ColumnLayout {
                ...
                AntText {
                    ...
                    font {
                        ...
                        pixelSize: AntTheme.Primary.fontPrimarySizeHeading4
                        bold: true
                    }
            ...
            Rectangle {
                ...
                color: {
                    if (__cardComp.tagState == 'New')
                        return AntTheme.Primary.colorError;
                    else if (__cardComp.tagState == 'Update')
                        AntTheme.Primary.colorSuccess;
                    else
                        return 'transparent';
                }
                ...
                Row {
                    ...
                    AntIconText {
                        ...
                        iconSize: AntTheme.Primary.fontPrimarySize
                        iconSource: AntIcon.FireFilled
                        color: 'white'
                    }
            ...
            AntIconText {
                ...
                anchors.margins: 10
                iconSize: 20
                iconSource: AntIcon.LinkOutlined
            }
        }

        component MyText: AntText {
        ...
        Column {
            ...
            Row {
                ...
                Item {
                    width: AntTheme.Primary.fontPrimarySize + 42
                    height: width
                    anchors.verticalCenter: parent.verticalCenter
                ...
                Item {
                    width: antillaTitle.width
                    height: antillaTitle.height
                    anchors.verticalCenter: parent.verticalCenter

                    MyText {
                        id: antillaTitle
                        text: qsTr('Antilla')
                        font.pixelSize: AntTheme.Primary.fontPrimarySize + 42
                    }

                    DropShadow {
                        anchors.fill: antillaTitle
                        shadowHorizontalOffset: 4
                        shadowVerticalOffset: 4
                        color: antillaTitle.color
                        source: antillaTitle
                        opacity: 0.6
            ...
            MyText {
                text: qsTr('定制主题，随心所欲')
                font.pixelSize: AntTheme.Primary.fontPrimarySize + 16
                font.bold: true
            }

            MyText {
                text: qsTr('Antilla 支持全局/组件的样式定制，内置多种接口让你定制主题更简单')
            }
            ...
            MyText {
                text: qsTr('Antilla 提供大量实用组件满足你的需求，基于代理的方式实现灵活定制与拓展')
            }
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Timer {
                        id: flickerTimer
                        interval: AntTheme.Primary.durationMid * 1.5
                        onTriggered: {
                    ...
                    Card {
                        ...
                        transform: Rotation {
                            ...
                            Behavior on angle { NumberAnimation { duration: AntTheme.Primary.durationMid } }
                        }
                        onClicked: {
