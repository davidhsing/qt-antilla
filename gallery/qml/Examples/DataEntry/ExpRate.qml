...
fillIcon | int丨string | AntIcon.StarFilled丨'' | 满星图标(来自 AntIcon)或图标链接
emptyIcon | int丨string | AntIcon.StarFilled丨'' | 空星图标(来自 AntIcon)或图标链接
halfIcon | int丨string | AntIcon.StarFilled丨'' | 半星图标(来自 AntIcon)或图标链接
\n<br/>
\n### 支持的信号：\n
...
Column {
    ...
    AntRate {
        ...
        colorEmpty: 'red'
        colorHalf: 'red'
        fillIcon: AntIcon.HeartFilled
        emptyIcon: AntIcon.HeartOutlined
        halfIcon: AntIcon.HeartFilled
    }
    ...
    AntRate {
        ...
        colorEmpty: 'green'
        colorHalf: 'green'
        fillIcon: AntIcon.LikeFilled
        emptyIcon: AntIcon.LikeOutlined
        halfIcon: AntIcon.LikeFilled
    }
}
            `
            exampleDelegate: Column {
...
Column {
    ...
    AntRate {
        ...
        initValue: 3
        colorFill: 'red'
        fillDelegate: AntIconText {
            iconSource: {
                if (index <= 2) return AntIcon.FrownOutlined;
                else if (index == 3) return AntIcon.MehOutlined;
                else return AntIcon.SmileOutlined;
            }
            iconSize: custom2.iconSize
            color: custom2.colorFill
            scale: hovered ? 1.1 : 1.0
        }
        emptyDelegate: AntIconText {
            iconSource: {
                if (index <= 2) return AntIcon.FrownOutlined;
                else if (index == 3) return AntIcon.MehOutlined;
                else return AntIcon.SmileOutlined;
