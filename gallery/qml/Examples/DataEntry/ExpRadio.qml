...
radiusIndicator | [AntRadius](internal://AntRadius) | 8 | 指示器圆角半径
ariaConstrual | string | '' | 内容描述(提高可用性)
        ...
        Description {
            ...
            desc: qsTr(`
- 用于在多个备选项中选中单个状态。\n
- 和 [AntSelect](internal://AntSelect) 的区别是，AntRadio 所有选项默认可见，方便用户在比较中选择，因此选项不宜过多。\n
                       `)
        }
...
Row {
    ...
    AntRadio {
        ...
        CodeBox {
            width: parent.width
            desc: qsTr(`
使用 \`ButtonGroup(QtQuick原生组件)\` 来实现一组互斥的 AntRadio 配合使用。\n
                       `)
            code: `
import QtQuick
import QtQuick.Controls.Basic
...
Row {
    ...
    AntRadio {
        ...
        AntIconText {
            ...
            iconSize: 24
            iconSource: AntIcon.LineChartOutlined
        }
    }
    ...
    AntRadio {
        ...
        AntIconText {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            iconSize: 24
            iconSource: AntIcon.DotChartOutlined
        }
    }
    ...
    AntRadio {
        ...
        AntIconText {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            iconSize: 24
            iconSource: AntIcon.BarChartOutlined
        }
    }
    ...
    AntRadio {
        ...
        AntIconText {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            iconSize: 24
            iconSource: AntIcon.PieChartOutlined
        }
    }
}
            `
