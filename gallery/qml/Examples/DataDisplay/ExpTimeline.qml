...
mode | enum | AntTimeline.ModeLeft | 时间节点展现模式(来自 AntTimeline)
...
Column {
    ...
    AntTimeline {
        ...
        initModel: [
            {
                colorNode: AntTheme.Primary.colorSuccess,
                content: 'Create a services site',
            },
            {
                colorNode: AntTheme.Primary.colorError,
                content: 'Solve initial network problems 1\nSolve initial network problems 2\nSolve initial network problems 3',
            },
            {
                colorNode: AntTheme.Primary.colorWarning,
...
- 时间在轴左侧(默认){ AntTimeline.ModeLeft }\n
- 时间在轴右侧{ AntTimeline.ModeRight }\n
- 交替展现{ AntTimeline.ModeAlternate }\n
...
Column {
    ...
    AntRadioBlock {
        ...
        initCheckedIndex: 0
        model: [
            { label: 'Left', value: AntTimeline.ModeLeft },
            { label: 'Right', value: AntTimeline.ModeRight },
            { label: 'Alternate', value: AntTimeline.ModeAlternate }
        ]
    }
