...
checkable | bool | false | 是否添加[AntCheckbox](internal://AntCheckbox)复选框
...
lineStyle | enum | AntTree.LineSolid | 连接线样式(来自 AntTree)
lineWidth | real | 1 | 连接线宽度
dashPattern | list | [4, 4] | 连接线虚线模式
switcherIconSouce | int丨string | AntIcon.CaretRightOutlined | 切换器图标源(来自 AntIcon)或图标链接
...
radiusSwitcherBg | [AntRadius](internal://AntRadius) | - | 切换器背景圆角
radiusTitleBg | [AntRadius](internal://AntRadius) | - | 节点标题背景圆角
marginIcon | [AntMargin](internal://AntMargin) | { left: 2 } | 图标边距
marginText | [AntMargin](internal://AntMargin) | { left: 3 } | 文本边距
verScrollBar | [AntScrollBar](internal://AntScrollBar) | - | 访问内部垂直滚动条
horScrollBar | [AntScrollBar](internal://AntScrollBar) | - | 访问内部水平滚动条
        ...
        initModel: [
            {
                title: 'parent 0',
                key: '0-0',
                iconSource: AntIcon.SmileOutlined,
                children: [
                    {
                        title: 'leaf',
                        key: '0-0-0',
                        iconSource: AntIcon.MehOutlined,
                    },
                    {
                        title: 'leaf',
                        key: '0-0-1',
                        iconSource: AntIcon.FrownFilled,
                    },
                ],
            },
        ]
...
Column {
    ...
    AntTree {
        lineVisible: true
        switcherIconSouce: AntIcon.DownOutlined
        Component.onCompleted: expandForKeys(['0-0-0']);
        initModel: [
            {
                title: 'parent 1',
            ...
            exampleDelegate: Column {
                ...
                AntTree {
                    lineVisible: true
                    switcherIconSouce: AntIcon.RightOutlined
                    Component.onCompleted: expandForKeys(['0-0-0']);
                    initModel: [
                        {
                            title: 'parent 1',
...
通过 \`dashPattern\` 设置虚线模式(style == AntTree.LineDashed 时有效)。\n
...
Column {
    ...
    AntRadioBlock {
        ...
        initCheckedIndex: 0
        model: [
            { label: 'LineSolid', value: AntTree.LineSolid },
            { label: 'LineDashed', value: AntTree.LineDashed },
        ]
    }
    ...
    AntTree {
        ...
        switcherDelegate: AntIconButton {
            padding: 0
            leftPadding: 0
            rightPadding: 0
            colorBorder: 'transparent'
            iconSource: isExpanded ? AntIcon.MinusSquareOutlined : AntIcon.PlusSquareOutlined
            onClicked: {
        ...
        initModel: [
           {
               title: 'parent 1',
               key: '0-0',
               iconSource: AntIcon.CarryOutOutlined,
               children: [
                   {
                       title: 'parent 1-0',
                       key: '0-0-0',
                       iconSource: AntIcon.CarryOutOutlined,
                       children: [
                           { title: 'leaf', key: '0-0-0-0', iconSource: AntIcon.CarryOutOutlined },
                           {
                               title: 'multiple line title\nmultiple line title',
                               key: '0-0-0-1',
                               iconSource: AntIcon.CarryOutOutlined,
                           },
                           { title: 'leaf', key: '0-0-0-2', iconSource: AntIcon.CarryOutOutlined },
                       ],
                   },
                   {
                       title: 'parent 1-1',
                       key: '0-0-1',
                       iconSource: AntIcon.CarryOutOutlined,
                       children: [{ title: 'leaf', key: '0-0-1-0', iconSource: AntIcon.CarryOutOutlined }],
                   },
                   {
                       title: 'parent 1-2',
                       key: '0-0-2',
                       iconSource: AntIcon.CarryOutOutlined,
                       children: [
                           { title: 'leaf', key: '0-0-2-0', iconSource: AntIcon.CarryOutOutlined },
                           {
                               title: 'leaf',
                               key: '0-0-2-1',
                               iconSource: AntIcon.CarryOutOutlined,
               ...
               children: [
                   {
                       ...
                       iconSource: AntIcon.CarryOutOutlined,
                       children: [
                           { title: 'leaf', key: '0-1-0-0', iconSource: AntIcon.CarryOutOutlined },
                           { title: 'leaf', key: '0-1-0-1', iconSource: AntIcon.CarryOutOutlined },
                       ],
                   },
               ],
           },
