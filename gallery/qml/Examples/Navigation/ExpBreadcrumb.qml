...
radiusItemBg | [AntRadius](internal://AntRadius) | - | 路由项的背景圆角半径
\n<br/>
\n### 模型支持的属性：\n
属性名 | 类型 | 可选/必选 | 描述
------ | --- | :---: | ---
...
iconSource | int | 可选 | 本路由项图标源(来自AntIcon)
...
AntBreadcrumb {
    ...
    initModel: [
        ...
        { iconSource: AntIcon.UserOutlined, title: 'Application List' },
        { loading: true, title: 'Application', },
    ]
}
            `
            exampleDelegate: AntBreadcrumb {
                initModel: [
                    { iconSource: AntIcon.HomeOutlined },
                    { iconSource: AntIcon.UserOutlined, title: 'Application List' },
                    { loading: true, title: 'Application', },
...
AntBreadcrumb {
    ...
    initModel: [
        ...
        CodeBox {
            ...
            desc: qsTr(`
面包屑支持下拉菜单。\n
通过 \`model.menu\` 属性设置为菜单即 [AntContextMenu](internal://AntContextMenu)。\n
通过 \`model.menu.items\` 属性设置菜单列表{即 \`AntContextMenu\` 的 \`initModel\` }。\n
