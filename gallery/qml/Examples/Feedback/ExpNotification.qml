...
type | int | 可选 | 通知类型(来自 AntNotification)
...
Item {
    ...
    AntNotification {
        ...
        position: AntNotification.PositionTopLeft
    }
    ...
    AntNotification {
        ...
        anchors.fill: parent
        anchors.topMargin: captionBar.height
        position: AntNotification.PositionTopRight
    }
    ...
    AntNotification {
        ...
        anchors.fill: parent
        anchors.topMargin: captionBar.height
        position: AntNotification.PositionBottomLeft
    }
    ...
    AntNotification {
        ...
        anchors.fill: parent
        anchors.topMargin: captionBar.height
        position: AntNotification.PositionTop
    }
    ...
    AntNotification {
        ...
        anchors.fill: parent
        anchors.topMargin: captionBar.height
        position: AntNotification.PositionBottom
    }
    ...
    Grid {
        ...
        AntIconButton {
            ...
            iconSource: AntIcon.RadiusUpleftOutlined
            text: 'TopLeft'
            onClicked: {
                notification1.info('Notification TopLeft', 'Hello, Antilla!');
            }
        }

        AntIconButton {
            type: AntButton.TypePrimary
            iconSource: AntIcon.RadiusUprightOutlined
            text: 'TopRight'
            onClicked: {
                notification2.info('Notification TopRight', 'Hello, Antilla!');
            }
        }

        AntIconButton {
            type: AntButton.TypePrimary
            iconSource: AntIcon.RadiusBottomleftOutlined
            text: 'BottomLeft'
            onClicked: {
                notification3.info('Notification BottomLeft', 'Hello, Antilla!');
            }
        }

        AntIconButton {
            type: AntButton.TypePrimary
            iconSource: AntIcon.RadiusBottomrightOutlined
            text: 'BottomRight'
            onClicked: {
                notification4.info('Notification BottomRight', 'Hello, Antilla!');
            }
        }

        AntIconButton {
            type: AntButton.TypePrimary
            iconSource: AntIcon.BorderTopOutlined
            text: 'Top'
            onClicked: {
                notification5.info('Notification Top', 'Hello, Antilla!');
            }
        }

        AntIconButton {
            type: AntButton.TypePrimary
            iconSource: AntIcon.BorderBottomOutlined
            text: 'Bottom'
            onClicked: {
                notification6.info('Notification Bottom', 'Hello, Antilla!');
            }
        }
    }
}
