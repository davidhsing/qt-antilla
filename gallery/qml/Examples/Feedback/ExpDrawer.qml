...
Row {
    AntButton {
        ...
        AntDrawer {
            ...
            contentDelegate: AntCopyableText {
                leftPadding: 15
                text: 'Some contents...\\nSome contents...\\nSome contents...'
            }
        }
...
- 起始位置(默认){ AntDrawer.PositionLeft }\n
- 末尾位置{ AntDrawer.PositionRight }\n
                       `)
            code: `
import QtQuick
import Antilla.Basic
...
Column {
    ...
    AntRadioBlock {
        ...
        initCheckedIndex: 0
        model: [
            { label: 'Close-Left', value: AntDrawer.PositionLeft },
            { label: 'Close-Right', value: AntDrawer.PositionRight }
        ]
    }
}
            `
